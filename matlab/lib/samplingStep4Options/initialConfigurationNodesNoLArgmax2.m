...
function [Ggen, FgenLin, maxNodes, feasibleEdgeVector, feasibilityEdgeVector,...
    selectedEdgesIndexedByFeasibleEdgeVector, selectedEdgeIndexedByType, P, dimBlocked]...
    = initialConfigurationNodesNoLArgmax2(Cgen, Fgen, numFgen, kernelDistanceFunction, ...
    kernelParameter, alfa, beta, gamma, gammaCut, zeta, iota, edgeExistenceThreshold, distances,...
    distancesCut, cutDegreeSum, connectedToGen, compatibleNodesGen, connectedToInternal, compatibleNodesInternal, corridors_label,numLabel,cont,skip_errors)
