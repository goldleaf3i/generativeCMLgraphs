...
function [Ggen, FgenLin, maxNodes, feasibleEdgeVector, feasibilityEdgeVector, selectedEdgesIndexedByFeasibleEdgeVector, selectedEdgeIndexedByType, P, dimBlocked] = initialConfigurationNodes2(Cgen, Fgen, numFgen, kernelDistanceFunction, kernelParameter, alfa, beta, gamma, gammaCut, zeta, iota, edgeExistenceThreshold, distances, distancesCut, cutDegreeSum, connectedToGen, compatibleNodesGen, connectedToInternal, compatibleNodesInternal, corridors_label,cont,skip_errors)
    numLabel = 25;
            ...
            if Cgen(ki,kj) > 0 && sum(feasibilityEdgeVector{ki,kj}) > 0
                ...
                if sumP > 0
                    ...
                    if skip_errors == 0
                        ...
                        warning(strcat('Problema di probabilita a ',num2str(cont),' ',datestr(datetime)));
                    end
