...
% 'parpool local N', where N is your wanted number of cores
...
%             [D_cc, p_cc] = graphshortestpath(sparse(AM_cc), newind_j);    % Single-source shortest path from node j in connected component
