%
% Questo script è stato creato per testare la funzione che deve sostituire
% il modulo di segmentation di ncut con quello alternativo
%
...
for k=1:num_grafi
    ...
    %     l'ultimo è praticamente una versione ri-disordinata di ordered_match
    ...
    for i=1:size(C_index,2)
        ...
        subgraphToNodeAssociation(match == C_index(i)) = i;
    end
end
